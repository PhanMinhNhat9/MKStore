...
<script>
    ...
    <?php
        $statusMessages = [
            ...
            'cnuserF' => ['Thất bại!', 'Cập nhật thông tin thất bại!', 'picture/error.png'],
            'themuserT' => ['Thành công!', 'Người dùng đã được thêm vào danh sách!', 'picture/success.png'],
            'themuserF' => ['Thất bại!', 'Thêm người dùng thất bại!', 'picture/error.png'],
            'cnspT' => ['Thành công!', 'Thông tin sản phẩm đã được cập nhật thành công!', 'picture/success.png'],
            'cnspF' => ['Thất bại!', 'Cập nhật sản phẩm thất bại!', 'picture/error.png'],
            'themspT' => ['Thành công!', 'Sản phẩm đã được thêm thành công!', 'picture/success.png'],
            'themspF' => ['Thất bại!', 'Thêm sản phẩm thất bại!', 'picture/error.png'],
            'xoaspT' => ['Thành công!', 'Xóa sản phẩm thành công!', 'picture/success.png'],
            'xoaspF' => ['Thất bại!', 'Xóa sản phẩm thất bại!', 'picture/error.png'],
            'cnanhuserT' => ['Thành công!', 'Cập nhật ảnh thành công!', 'picture/success.png'],
            'cnanhuserF' => ['Thất bại!', 'Cập nhật ảnh không thành công!', 'picture/error.png'],
            'laylaispT' => ['Thành công!','Lấy lại tài khoản thành công!', 'picture/success.png'],
            'laylaispF' => ['Thất bại!','Lỗi khi cấp lại tài!', 'picture/error.png'],
            'themdmT' => ['Thành công!','Thêm danh mục thành công!', 'picture/success.png'],
            'cndmT' => ['Thành công!', 'Cập nhật ảnh thành công!', 'picture/success.png'],
            'cndmF' => ['Thất bại!', 'Cập nhật ảnh thất bại!', 'picture/error.png'],
            'nhanhangT' => ['Thành công!','Bạn đã nhận hàng thành công!','picture/success.png'],
            'nhanhangF' => ['Thất bại!','Cập nhật trạng thái nhận hàng thất bại!','picture/error.png'],
            'khoiphucdhT' => ['Thành công!','Bạn đã khôi phục đơn hàng thành công!','picture/success.png'],
            'khoiphucdhF' => ['Thất bại!','Bạn không thể khôi phục đơn hàng!','picture/error.png'],
            'KHXoaT' => ['Thành công!','Bạn đã thực hiện kích hoạt xóa TK thành công!','picture/success.png'],
            'KHXoaF' => ['Thất bại!','Bạn không thể kích hoạt xóa!','picture/error.png']
        ];
